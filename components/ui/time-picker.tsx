...
function TimePickerHeader() {
  ...
  return (
    <div className="flex mx-1 text-3xl items-center gap-1 justify-center group" data-selecting={picking}>
      <Button
      className="h-14 w-20 text-3xl group-data-[selecting='hour']:bg-primary group-data-[selecting='hour']:text-primary-foreground transition-colors" 
      ...
      <span>:</span>
      <Button
      className="h-14 w-20 text-3xl group-data-[selecting='minute']:bg-primary group-data-[selecting='minute']:text-primary-foreground transition-colors" 
