  ...
  return (
    ...
    <Drawer>
      <DrawerTrigger asChild>
        <Button size="icon" className='rounded-full bottom-1 absolute right-2 hover:bg-primary'><Plus/></Button>
      </DrawerTrigger>
      <DrawerContent>
        ...
        <Label>Plats</Label>
        <div className='flex'>           
        <Input></Input><Button className='ml-1 px-2' variant={'outline'}><MapPin className='size-4' /></Button>
        </div>
      </div>
          </div>
          <DrawerFooter>
